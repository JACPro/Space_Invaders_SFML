...
public:
	...
	{
		// Where is the player?
		auto player = gos->findFirstObjectWithTag("Player");
		m_PlayerTC = std::static_pointer_cast<TransformComponent>(player.getComponentByTypeAndSpecificType("transform", "transform"));
		m_PlayerRCC = std::static_pointer_cast<RectColliderComponent>(player.getComponentByTypeAndSpecificType("collider", "rect"));
